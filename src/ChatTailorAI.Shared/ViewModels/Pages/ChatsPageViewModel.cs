...
namespace ChatTailorAI.Shared.ViewModels.Pages
{
    public class ChatsPageViewModel : Observable, IDisposable
    {
        ...
        private readonly IInAppNotificationService _appNotificationService;
        ...
        public ChatsPageViewModel(
            ...
            IInAppNotificationService appNotificationService,
        ...
        public bool HasOpenTabs
        {
            get => _hasOpenTabs;
            set => SetProperty(ref _hasOpenTabs, value);
        }
        ...
        private void OnChatUpdated(object sender, ChatUpdatedEvent e)
        {
            ...
            // TODO: Setup binding for the selectedchas that are conversations
        ...
        private async Task LoadChats()
        {
            ...
            {
                // TODO: Fix database loading issue when data is null
