...
namespace ChatTailorAI.Services.Tools
{
    public class SpotifyService : ISpotifyService
    {
        ...
        public async Task<string> RefreshAccessToken()
        {
            ...
            var data = JsonService.SafeDeserialize<dynamic>(responseContent);
        ...
        public async Task<SpotifyPlaylist> GetUserPlaylists()
        {
            ...
            var responseContent = await response.Content.ReadAsStringAsync();
            var data = JsonService.SafeDeserialize<SpotifyPlaylist>(responseContent);
        ...
        public async Task PlayTrack(string uri)
        {
            ...
            var jsonString = JsonService.SafeSerialize(new { uris = new[] { uri } });
        ...
        public async Task<string> AddTrackToPlaylist(string playlistId, string trackUri)
        {
            ...
            var jsonString = JsonService.SafeSerialize(new { uris = new[] { trackUri } });
            var content = new StringContent(jsonString, Encoding.UTF8, "application/json");
